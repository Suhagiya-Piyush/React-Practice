    ...
    <>
      <div className="bg-slate-200 px-10">
        <footer className="pt-10 mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-7 py-6 border-b border-gray-400">
            <div className="lg:col-span-2 text-left sm:pb-10 pe-8">
              <img src={logo} alt="logo" className="h-6 mb-10" />
              <p className="text-xs text-gray-500">
                Elegant pink origami design three dimensional view and
                decoration co-exist. Great for adding a decorative touch to any
                room’s decor.
              </p>
            </div>
            ...
            <div className="text-start text-sm lg:col-span-2">
              ...
              <div className="mt-4">
                <input
                  type="text"
                  className="py-4 px-4 focus:outline-none rounded-lg w-[75%]"
                  placeholder="Enter email address"
                />
                <button className="text-white text-xs py-4 px-10 mt-2 rounded-lg button">
                  Subscribe Now
          ...
          <div className="">
            <div className="grid grid-cols-1 lg:grid-cols-2 py-4">
              <div className="columns-1 flex justify-center lg:justify-start my-2 lg:my-0">
                <span className="h-14 w-14 bg-white rounded-full flex items-center justify-center text-2xl">
                  <i className="fa-solid fa-phone-flip"></i>
                </span>
                <div className="ms-4 py-2">
                  <h4 className="text-sm font-bold mb-1 hover:text-red-600 cursor-pointer transition-all">
                    980. 029. 666. 99
                  </h4>
                  <p className="text-xs text-gray-500">Working 8:00 - 22:00</p>
                </div>
              </div>
              <div className="columns-1 flex justify-center lg:justify-end items-center my-2 lg:my-0">
                ...
                <div className="flex flex-wrap gap-2 ms-4">
                  <img src={google} alt="google" className="h-12 my-1" />
                  <img src={apple} alt="apple" className="h-12 my-1" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-2 footer-bg py-2 px-10">
        <div className="columns-1 text-left">
          <p className="text-sm text-gray-500">
            Copyright 2024{" "}
            <span className="text-black font-semibold hover:text-red-600 cursor-pointer transition-all">
              ©Ninico
            </span>
